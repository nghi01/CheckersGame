...
// MIGHT DELETE
    // private void Medium_Level(Dictionary<(int, int), List<(int, int)>> moves, Dictionary<(int, int), List<(int, int)>> kill_moves)
    // {
    //   bool noValidMove = true;
    //   bool noKillMove = true;

    //   Dictionary<(int, int), List<(int, int)>> chosenDict;
    ...
    //   foreach (KeyValuePair<(int, int), List<(int, int)>> kvp in kill_moves)
    //   {
    //     // check size of the list of moves for each piece/key
    //     if (kvp.Value.Count>0)
    //     {
    ...
    //     int keynum =  Random.Range(0, chosenDict.Count+1);
    ...
    //     foreach (KeyValuePair<(int, int), List<(int, int)>> kvp in chosenDict)
    //       {
